...
<div class="max-w-lg mx-auto">
    <div class="bg-white rounded-xl shadow p-6" id="receipt">
        ...
        <div class="border-t border-b py-3 mb-4 text-sm">
            ...
            <div class="flex justify-between"><span>Served by:</span><span>{{ $sale->cashier?->name ?? '—' }}</span></div>
            @if(!empty($sale->notes))
    ...
    <div class="mt-4 text-center">
        <a href="{{ route('customer-care.sales.index') }}" class="text-amber-700 hover:underline"><i class="fas fa-arrow-left mr-1"></i> Back to Sales</a>
    </div>
</div>
@endsection