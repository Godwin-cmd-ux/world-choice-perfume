...
@section('content')
<a href="{{ route('customer-care.sales.index') }}" class="inline-block text-sm text-gray-500 hover:text-gray-700 mb-4">
    <i class="fas fa-arrow-left mr-1"></i> Back to Sales
</a>

<form method="POST" action="{{ route('customer-care.sales.store') }}" id="saleForm">
    @csrf
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-xl shadow p-6">
                ...
                <button type="button" onclick="addBottleRow()" class="mt-3 text-amber-700 hover:underline text-sm">
