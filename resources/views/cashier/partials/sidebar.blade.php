<aside id="sidebar" class="sidebar bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 text-white flex-shrink-0 flex flex-col">
    ...
    <nav class="flex-1 p-4 space-y-1">
        <a href="{{ route('cashier.dashboard') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('cashier.dashboard') ? 'bg-amber-600 text-white shadow-lg shadow-amber-600/30' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
            <i class="fas fa-tachometer-alt w-5 text-center"></i>
            <span>Dashboard</span>
        </a>
        <a href="{{ route('cashier.sales.index') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('cashier.sales.*') ? 'bg-amber-600 text-white shadow-lg shadow-amber-600/30' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
    ...
    <div class="p-4 border-t border-gray-700">
        <div class="flex items-center gap-3">
            ...
            <div class="flex-1 min-w-0">
                ...
                <p class="text-[10px] text-amber-400 uppercase tracking-wider">Cashier</p>
            </div>
        </div>
    </div>
</aside>
