...
<form method="POST" action="{{ route('seller.sales.store') }}" id="saleForm">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-xl shadow p-4">
                ...
                <div class="flex gap-2">
                    ...
                    <button type="button" onclick="setSaleType('wholesale')" id="tab-wholesale"
                        class="flex-1 py-2.5 rounded-lg text-sm font-semibold transition-all bg-gray-100 text-gray-600 hover:bg-cyan-100 hover:text-cyan-700">
        ...
        <div class="lg:col-span-2 space-y-6">
            @include('partials.sale-products-card', ['accent' => 'cyan'])
...
@push('scripts')
@include('partials.sale-script', ['accent' => 'cyan'])
@endpush
@endsection