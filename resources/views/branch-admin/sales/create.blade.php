        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <div class="bg-white rounded-xl shadow p-4">
                ...
                <div class="flex gap-2">
                    ...
                    <button type="button" onclick="setSaleType('wholesale')" id="tab-wholesale" class="flex-1 py-2.5 rounded-lg text-sm font-semibold transition-all bg-gray-100 text-gray-600 hover:bg-amber-100 hover:text-amber-700">
