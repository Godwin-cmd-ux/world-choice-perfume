...
<section class="min-h-screen flex items-center justify-center pt-20 pb-12 px-4">
    <div class="w-full max-w-md fade-in">
        ...
        <div class="bg-dark-800/50 border border-dark-600 rounded-2xl p-8">
            ...
            <form method="POST" action="{{ route('register.graphic-designer') }}">
                @csrf
                <div class="space-y-4">
                    <div>
                ...
                <button type="submit" class="w-full mt-6 py-3 bg-gradient-to-r from-purple-500 to-purple-600 text-white font-semibold rounded-xl hover:from-purple-400 hover:to-purple-500 transition-all duration-300 shadow-lg shadow-purple-500/25">
                    <i class="fas fa-user-plus mr-2"></i> Register as Graphic Designer
                </button>
            </form>

            <div class="mt-4 text-center">
                <p class="text-xs text-gray-500">
                    <i class="fas fa-info-circle mr-1"></i> Your account will be reviewed and approved by the Super Admin before activation.
                </p>
            </div>
        </div>
