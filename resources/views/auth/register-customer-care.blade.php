...
@section('title', 'Customer Care Registration — World Choice Perfumes')
...
<section class="min-h-screen flex items-center justify-center pt-20 pb-12 px-4">
    <div class="w-full max-w-md fade-in">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-400 mt-2">Register as Customer Care at World Choice Perfumes</p>
        </div>
        ...
        <div class="bg-dark-800/50 border border-dark-600 rounded-2xl p-8">
            ...
            <form method="POST" action="{{ route('register.customer-care') }}">
                @csrf
                <div class="space-y-4">
                    <div>
                ...
                <button type="submit" class="w-full mt-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-semibold rounded-xl hover:from-blue-400 hover:to-blue-500 transition-all duration-300 shadow-lg shadow-blue-500/25">
                    <i class="fas fa-user-plus mr-2"></i> Register as Customer Care
                </button>
            </form>

            <div class="mt-4 text-center">
                <p class="text-xs text-gray-500">
                    <i class="fas fa-info-circle mr-1"></i> Your account will be reviewed by the admin before activation.
                </p>
            </div>
        </div>
