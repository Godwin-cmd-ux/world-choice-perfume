...
@section('title', 'Seller Registration — World Choice Perfumes')
...
<section class="min-h-screen flex items-center justify-center pt-20 pb-12 px-4">
    <div class="w-full max-w-md fade-in">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-400 mt-2">Register as a Seller at World Choice Perfumes</p>
        </div>
        ...
        <div class="bg-dark-800/50 border border-dark-600 rounded-2xl p-8">
            ...
            <form method="POST" action="{{ route('register.seller') }}">
                ...
                <button type="submit" class="w-full mt-6 py-3 bg-gradient-to-r from-cyan-500 to-cyan-600 text-white font-semibold rounded-xl hover:from-cyan-400 hover:to-cyan-500 transition-all duration-300 shadow-lg shadow-cyan-500/25">
                    <i class="fas fa-user-plus mr-2"></i> Register as Seller
                </button>
            </form>
