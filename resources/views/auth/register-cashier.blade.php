...
@section('title', 'Cashier Registration — World Choice Perfumes')
...
<section class="min-h-screen flex items-center justify-center pt-20 pb-12 px-4">
    <div class="w-full max-w-md fade-in">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-400 mt-2">Register as a Cashier at World Choice Perfumes</p>
        </div>
        ...
        <div class="bg-dark-800/50 border border-dark-600 rounded-2xl p-8">
            ...
            <form method="POST" action="{{ route('register.cashier') }}" enctype="multipart/form-data">
                @csrf
                <div class="space-y-4">
                    <div>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-300 mb-2">Profile Photo <span class="text-gray-500">(optional)</span></label>
                        <input type="file" name="profile_picture" accept="image/*"
                            class="w-full px-4 py-3 bg-dark-700 border border-dark-600 rounded-xl text-white file:mr-4 file:py-1 file:px-3 file:rounded-lg file:border-0 file:bg-gold-500/10 file:text-gold-400 file:font-medium file:text-sm hover:file:bg-gold-500/20 transition outline-none">
                    </div>
                </div>
                ...
                <button type="submit" class="w-full mt-6 py-3 bg-gradient-to-r from-gold-500 to-gold-600 text-dark-900 font-semibold rounded-xl hover:from-gold-400 hover:to-gold-500 transition-all duration-300 shadow-lg shadow-gold-500/25">
                    <i class="fas fa-user-plus mr-2"></i> Register as Cashier
                </button>
            </form>
