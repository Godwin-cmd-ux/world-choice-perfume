...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    <a href="{{ route('super-admin.reports.sales') }}" class="bg-white rounded-xl shadow p-6 hover:shadow-lg transition group">
    ...
    <a href="{{ route('super-admin.reports.expenses') }}" class="bg-white rounded-xl shadow p-6 hover:shadow-lg transition group">
    ...
    <a href="{{ route('super-admin.reports.stock') }}" class="bg-white rounded-xl shadow p-6 hover:shadow-lg transition group">
    ...
    <a href="{{ route('super-admin.reports.staff-performance') }}" class="bg-white rounded-xl shadow p-6 hover:shadow-lg transition group">
        ...
        <h3 class="font-semibold text-lg">Staff Performance</h3>
        <p class="text-sm text-gray-500">Sales & activity by all staff members</p>
    </a>
    <a href="{{ route('super-admin.reports.product-performance') }}" class="bg-white rounded-xl shadow p-6 hover:shadow-lg transition group">
        ...
        <p class="text-sm text-gray-500">Top sellers, slow movers</p>
    </a>
</div>
@endsection
