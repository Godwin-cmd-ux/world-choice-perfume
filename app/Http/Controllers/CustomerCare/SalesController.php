...
class SalesController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('customer-care.sales.create', compact('products', 'bottleStock', 'bottleVariants', 'productVarieties'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // 5. Empty bottle lines (empty bottles sold directly)
            ...
            if ($priceOverridden) {
                (new \App\Services\AuditService())->recordCriticalAction(
                    ...
                    'custom_price_sale',
                    'Price Customized',
                    "A custom sale price was used in sale {$saleNumber} (Customer Care).",
            ...
            return redirect()->route('customer-care.sales.show', $sale['id'])
    ...
    public function show($saleId)
    {
        ...
        if (!$sale || ($sale['branch_id'] ?? null) != $branchId) {
            abort(403);
        }
        ...
        return view('customer-care.sales.show', ['sale' => (object) $sale]);
    }
}