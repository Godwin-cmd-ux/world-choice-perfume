...
class OrderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('customer-care.orders.index', ['orders' => $orders, 'transitions' => self::TRANSITIONS]);
    }
    ...
    public function show($orderId)
    {
        ...
        return view('customer-care.orders.show', ['order' => (object) $order, 'transitions' => self::TRANSITIONS]);
    }
